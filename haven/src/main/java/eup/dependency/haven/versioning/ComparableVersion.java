package eup.dependency.haven.versioning;
...
public class ComparableVersion implements Comparable<ComparableVersion> {
  ...
  /**
   * Represents a combination in the version item list. It is usually a combination of a string and
   * a number, with the string first and the number second.
   */
